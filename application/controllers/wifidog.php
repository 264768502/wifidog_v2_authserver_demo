	...
	public function ping()
	{
		...
		*/
		...
		$hostrule = array(
					...
					//一条主机规则：针对192.168.1.9单个ip，配置上行不受限，下行为2400bps/300Bps的规则
					array('ip'=>'192.168.1.9','netmask'=>'255.255.255.255','up'=>'0','down'=>'2400','session'=>'0'),
					//一条网段规则：针对192.168.1.0/24整个网段，配置该网段内的所有主机上行为8000bps/1000Bps 约1KBps，下行为16000000bps/2000000Bps 约2MBps的规则
					array('ip'=>'192.168.1.0','netmask'=>'255.255.255.0','up'=>'8000','down'=>'16000000','session'=>'0'),
					//......其他规则
					);
